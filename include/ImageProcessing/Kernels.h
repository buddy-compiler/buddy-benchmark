...
static uint8_t random5x5KernelAlignInt[25] = {1, 9, 8, 8, 1, 
                                         6, 6, 3, 3, 7, 
                                         1, 9, 5, 5, 7, 
                                         4, 5, 4, 3, 2, 
                                         9, 8, 3, 8, 9};                                         
...
static uint8_t random7x7KernelAlignInt[49] = {6, 3, 1, 5, 1, 9, 4, 
                                        0, 0, 8, 0, 5, 0, 2, 
                                        9, 1, 7, 6, 1, 3, 8, 
                                        4, 5, 2, 6, 3, 9, 1, 
                                        7, 7, 2, 6, 7, 8, 6, 
...
static uint8_t random9x9KernelAlignInt[81] = {7, 9, 5, 0, 9, 8, 4, 9, 9, 
                                         4, 7, 0, 8, 3, 3, 2, 8, 7, 
                                         1, 0, 5, 5, 9, 4, 1, 7, 0, 
                                         6, 1, 5, 4, 1, 8, 4, 8, 4, 
                                         4, 9, 5, 7, 5, 6, 7, 1, 3, 
...
static uint8_t random11x11KernelAlignInt[121] = {4, 5, 7, 6, 3, 6, 6, 6, 1, 9, 8,
                                            5, 2, 0, 0, 9, 0, 1, 9, 7, 0, 8,
                                            7, 8, 4, 4, 1, 5, 5, 3, 4, 9, 8,
                                            4, 7, 1, 2, 3, 9, 3, 2, 9, 0, 7,
                                            9, 2, 6, 0, 5, 7, 9, 6, 5, 8, 6,
...
static std::map<std::string, std::tuple<uint8_t*, int, int>> kernelMap1 = {
    ...
    {"random5x5KernelAlignInt", {random5x5KernelAlignInt, random5x5KernelRows, random5x5KernelCols}},
    {"random7x7KernelAlignInt", {random7x7KernelAlignInt, random7x7KernelRows, random7x7KernelCols}},
    {"random9x9KernelAlignInt", {random9x9KernelAlignInt, random9x9KernelRows, random9x9KernelCols}},
    {"random11x11KernelAlignInt", {random11x11KernelAlignInt, random11x11KernelRows, random11x11KernelCols}},
