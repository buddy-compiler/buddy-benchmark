...
def main():
    ...
    evaluate_operation(s_1, inputs=data, optimization="torch_pooling_default", log=log)

    s_2 = pool_compiled(k, p, s)
    evaluate_operation(s_2, inputs=data, optimization="torch_pooling_dynamo", log=log)
