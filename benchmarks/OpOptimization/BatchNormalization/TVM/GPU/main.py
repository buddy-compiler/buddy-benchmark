...
# ===---------------------------------------------------------------------------
#
# This file implements the TVM optimization entry for batchNormalization on GPU.
...
def main():
    ...
    evaluate_operation(
        sch, arg_bufs, target=target, inputs=test_input, optimization="auto_bn", log=log
    )
    # Register numpy case.
