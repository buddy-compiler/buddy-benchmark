func.func @matmul_transform(%A: memref<64x576xf32>, %B: memref<576x3136xf32>, %C: memref<64x3136xf32>) {
  linalg.matmul
    ins(%A, %B: memref<64x576xf32>, memref<576x3136xf32>)
   outs(%C: memref<64x3136xf32>)
  return
}
