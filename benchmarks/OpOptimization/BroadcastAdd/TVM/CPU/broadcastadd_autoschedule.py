...
# ===---------------------------------------------------------------------------
#
# This file implements the TVM auto optimization entry for broadcastAdd on CPU.
...
def BroadcastAdd_auto_tuning_plus(args, target):
    ...
    task = tvm.auto_scheduler.SearchTask(
        func=BroadcastAdd, args=(shape1, shape2), target=target
    )
