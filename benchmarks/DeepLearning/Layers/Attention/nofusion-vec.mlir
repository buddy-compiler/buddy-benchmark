module {
  ...
  func.func @nofuseveckenerl(%arg0: tensor<32x40x128xf32>, %arg1: tensor<32x128x40xf32>, %arg2: tensor<1x1x40x40xf32>, %arg3: tensor<1x32x40x128xf32>) {
      ...
      affine.parallel (%arg5) = (0) to (32) {
        affine.for %arg6 = 0 to 40 {
          affine.for %arg7 = 0 to 40 step 40{
            ...
            vector.transfer_write %t1,%alloc_3[%arg4, %arg5, %arg6, %arg7] : vector<40xf32> , memref<1x32x40x40xf32>
      ...
      affine.parallel (%arg5) = (0) to (32) {
        affine.for %arg6 = 0 to 40 {
          affine.for %arg7 = 0 to 40 step 40{
            ...
            %c2 = arith.constant 0.000000e+00 : f32
            %6 = vector.transfer_read %alloc_3[%c0, %arg5, %arg6, %arg7],%c2 : memref<1x32x40x40xf32> , vector<40xf32>
            %7 = arith.mulf %5, %6 : vector<40xf32>
            vector.transfer_write %7, %alloc_4[%arg4, %arg5, %arg6, %arg7] : vector<40xf32>, memref<1x32x40x40xf32>
    ...
    affine.for %arg4 = 0 to 1 {
      affine.parallel (%arg5) = (0) to (32) {
        affine.for %arg6 = 0 to 40 {
          affine.for %arg7 = 0 to 40 step 40{
            %c1 = arith.constant 0.000000e+00 : f32
            %5 = vector.transfer_read %alloc_4[%c0, %arg5, %arg6, %arg7],%c1 : memref<1x32x40x40xf32> , vector<40xf32>
            %c2 = arith.constant 0.000000e+00 : f32
            %6 = vector.transfer_read %1[%c0, %c0, %arg6, %arg7],%c2 : memref<1x1x40x40xf32, strided<[?, ?, ?, ?], offset: ?>> , vector<40xf32>
            %7 = arith.addf %5, %6 : vector<40xf32>
            vector.transfer_write %7, %alloc_5[%arg4, %arg5, %arg6, %arg7] : vector<40xf32>,memref<1x32x40x40xf32>
    ...
    affine.for %arg4 = 0 to 1 {
      affine.parallel (%arg5) = (0) to (32) {
        affine.for %arg6 = 0 to 40 {
          affine.for %arg7 = 0 to 40 step 40{
            %c1 = arith.constant 0.000000e+00 : f32
            %5 = vector.transfer_read %alloc_5[%arg4, %arg5, %arg6, %arg7],%c1 : memref<1x32x40x40xf32> , vector<40xf32>
            %6 = vector.reduction<maxf>, %5 : vector<40xf32> into f32
            %7 = arith.cmpf ugt, %6, %cst_2 : f32
            %8 = arith.select %7, %6, %cst_2 : f32
            affine.store %8, %alloc_6[%arg4, %arg5, %arg6] : memref<1x32x40xf32>
      ...
      affine.parallel (%arg5) = (0) to (32) {
        affine.for %arg6 = 0 to 40 {
          affine.for %arg7 = 0 to 40 step 40{
            ...
            %c2 = arith.constant 0.000000e+00 : f32
            %6 = vector.transfer_read %expand_shape_7[%c0, %arg5, %arg6, %c0],%c2 {permutation_map = affine_map<(d0,d1,d2,d3)->(0)> }: memref<1x32x40x1xf32> , vector<40xf32>
            %7 = arith.subf %5, %6 : vector<40xf32>
            vector.transfer_write %7, %alloc_8[%arg4, %arg5, %arg6, %arg7] : vector<40xf32>, memref<1x32x40x40xf32>
    ...
    affine.for %arg4 = 0 to 1 {
      affine.parallel (%arg5) = (0) to (32) {
        affine.for %arg6 = 0 to 40 {
          affine.for %arg7 = 0 to 40 step 40{
            %c1 = arith.constant 0.000000e+00 : f32
            %5 = vector.transfer_read %alloc_8[%c0, %arg5, %arg6, %arg7],%c1 : memref<1x32x40x40xf32> , vector<40xf32>
            %6 = math.exp %5 : vector<40xf32>
            vector.transfer_write %6,%alloc_9[%arg4, %arg5, %arg6, %arg7] : vector<40xf32>, memref<1x32x40x40xf32>
  ...
  func.func @main5() {
    ...
    call @nofuseveckenerl(%1, %3, %5, %7) : (tensor<32x40x128xf32>, tensor<32x128x40xf32>, tensor<1x1x40x40xf32>, tensor<1x32x40x128xf32>) -> ()
    return
  }
}
