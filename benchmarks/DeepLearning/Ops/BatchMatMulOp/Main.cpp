...
void MLIRVerification(float *outputExpected, MLIRFunctionType MLIRFunc,
  ...
  matmul::verify<float>(outputExpected, outputOptimized, BATCH_SIZE,
...
int main(int argc, char **argv) {
  ...
  input1 = matmul::allocArray<float>(BATCH_SIZE * _SIZE_M, _SIZE_K);
  input2 = matmul::allocArray<float>(BATCH_SIZE * _SIZE_K, _SIZE_N);
