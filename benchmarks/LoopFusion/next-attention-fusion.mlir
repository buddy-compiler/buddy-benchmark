...
module {
  ...
  func.func @fusionkenerl(%arg0: tensor<32x40x128xf32>, %arg1: tensor<32x128x40xf32>, %arg2: tensor<1x1x40x40xf32>, %arg3: tensor<1x32x40x128xf32>) {
    ...
    // Fusion: Reshape + Constant + Reciprocal + Multiplication + Addition + Reduce Max
      ...
      affine.for %arg5 = 0 to 32 {
        affine.for %arg6 = 0 to 40 {
          affine.for %arg7 = 0 to 40 {
            ...
            %10 = arith.cmpf ugt, %8, %9 : f32
            %11 = arith.select %10, %8, %9 : f32
            affine.store %11, %alloc_6[%arg4, %arg5, %arg6] : memref<1x32x40xf32>
            affine.store %8, %alloc_5[%arg4, %arg5, %arg6, %arg7] : memref<1x32x40x40xf32>
          }
        }
      }
    }

    // Fusion: Subtraction + Exponentiation + Reduce Sum
      ...
      affine.for %arg5 = 0 to 32 {
        affine.for %arg6 = 0 to 40 {
          affine.for %arg7 = 0 to 40 {
            ...
            // Fusion point: subtraction
            %7 = arith.subf %5, %6 : f32
            // Fusion point: exponentiation
            %8 = math.exp %7 : f32
            // Fusion point: reduce sum
            %9 = affine.load %alloc_10[%arg4, %arg5, %arg6] : memref<1x32x40xf32>
            %10 = arith.addf %8, %9 : f32
            affine.store %10, %alloc_10[%arg4, %arg5, %arg6] : memref<1x32x40xf32>
            affine.store %8, %alloc_9[%arg4, %arg5, %arg6, %arg7] : memref<1x32x40x40xf32>
          }
        }
      }
    }
