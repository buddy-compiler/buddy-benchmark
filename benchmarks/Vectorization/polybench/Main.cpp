...
void startDump() { std::cout << "==BEGIN DUMP_ARRAYS==" << std::endl; }

void finishDump() { std::cout << "==END   DUMP_ARRAYS==" << std::endl; }

void beginDump(const std::string &name) { std::cout << "begin dump: " << name; }
