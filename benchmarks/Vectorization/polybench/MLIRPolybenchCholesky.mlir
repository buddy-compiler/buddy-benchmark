...
//===----------------------------------------------------------------------===//
//
// This file provides initialization and kernel functions for the cholesky
...
func.func @cholesky_init_array(%arg0: i32, %arg1: memref<?x?xf64>) {
...
func.func @cholesky_kernel(%arg0: i32, %arg1: memref<?x?xf64>) {
  %0 = arith.index_cast %arg0 : i32 to index
  affine.for %arg2 = 0 to %0 {
    affine.for %arg3 = 0 to #map(%arg2) {
      affine.for %arg4 = 0 to #map(%arg3) {
        %6 = affine.load %arg1[%arg2, %arg4] : memref<?x?xf64>
        %7 = affine.load %arg1[%arg3, %arg4] : memref<?x?xf64>
        %8 = arith.mulf %6, %7 : f64
        %9 = affine.load %arg1[%arg2, %arg3] : memref<?x?xf64>
        %10 = arith.subf %9, %8 : f64
        affine.store %10, %arg1[%arg2, %arg3] : memref<?x?xf64>
      }
      %3 = affine.load %arg1[%arg3, %arg3] : memref<?x?xf64>
    ...
    affine.for %arg3 = 0 to #map(%arg2) {
      ...
      %5 = affine.load %arg1[%arg2, %arg2] : memref<?x?xf64>
      %6 = arith.subf %5, %4 : f64
      affine.store %6, %arg1[%arg2, %arg2] : memref<?x?xf64>
    }
    %1 = affine.load %arg1[%arg2, %arg2] : memref<?x?xf64>
    %2 = math.sqrt %1 : f64
    affine.store %2, %arg1[%arg2, %arg2] : memref<?x?xf64>
  }
  return
}
