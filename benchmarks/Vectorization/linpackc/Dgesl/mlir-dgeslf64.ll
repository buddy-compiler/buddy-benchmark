...
declare double @mlir_linpackcddotrollf64(i32, ptr, ptr, i64, i64, i64, i32, ptr, ptr, i64, i64, i64, i32)

declare void @mlir_linpackcdaxpyunrollf64(i32, double, ptr, ptr, i64, i64, i64, i32, ptr, ptr, i64, i64, i64, i32)

declare double @mlir_linpackcddotunrollf64(i32, ptr, ptr, i64, i64, i64, i32, ptr, ptr, i64, i64, i64, i32)

declare void @_mlir_ciface_mlir_linpackcdaxpyrollf64(i32, double, ptr, i32, ptr, i32)

declare double @_mlir_ciface_mlir_linpackcddotrollf64(i32, ptr, i32, ptr, i32)

declare void @_mlir_ciface_mlir_linpackcdaxpyunrollf64(i32, double, ptr, i32, ptr, i32)

declare double @_mlir_ciface_mlir_linpackcddotunrollf64(i32, ptr, i32, ptr, i32)

define double @get_val_dgesl_f64(ptr %0, ptr %1, i64 %2, i64 %3, i64 %4, i64 %5, i64 %6, i64 %7) {
...
define double @_mlir_ciface_get_val_dgesl_f64(ptr %0, i64 %1, i64 %2, i64 %3) {
  ...
  %11 = call double @get_val_dgesl_f64(ptr %6, ptr %7, i64 %8, i64 %9, i64 %10, i64 %1, i64 %2, i64 %3)
  ret double %11
}

define void @set_val_dgesl_f64(ptr %0, ptr %1, i64 %2, i64 %3, i64 %4, i64 %5, i64 %6, i64 %7, double %8) {
...
define void @_mlir_ciface_set_val_dgesl_f64(ptr %0, i64 %1, i64 %2, i64 %3, double %4) {
  ...
  call void @set_val_dgesl_f64(ptr %7, ptr %8, i64 %9, i64 %10, i64 %11, i64 %1, i64 %2, i64 %3, double %4)
  ret void
}

define i64 @get_offset_dgesl_f64(i64 %0, i64 %1, i64 %2) {
  %4 = mul i64 %0, %1
  %5 = add i64 %4, %2
  ret i64 %5
}

define i64 @_mlir_ciface_get_offset_dgesl_f64(i64 %0, i64 %1, i64 %2) {
  %4 = call i64 @get_offset_dgesl_f64(i64 %0, i64 %1, i64 %2)
  ret i64 %4
}

define void @mlir_linpackcdgeslrollf64(ptr %0, ptr %1, i64 %2, i64 %3, i64 %4, i32 %5, i32 %6, ptr %7, ptr %8, i64 %9, i64 %10, i64 %11, ptr %12, ptr %13, i64 %14, i64 %15, i64 %16, i32 %17) {
...
64:                                               ; preds = %53
  ...
  %66 = getelementptr double, ptr %65, i64 %51
  %67 = load double, ptr %66, align 8
  %68 = extractvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %33, 1
  %69 = getelementptr double, ptr %68, i64 %59
  store double %67, ptr %69, align 8
  %70 = extractvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %33, 1
  %71 = getelementptr double, ptr %70, i64 %51
  store double %62, ptr %71, align 8
  br label %72

72:                                               ; preds = %64, %53
  %73 = sub i32 %6, %55
  %74 = call i64 @get_offset_dgesl_f64(i64 %37, i64 %51, i64 %54)
  %75 = sub i64 %41, %74
  ...
  call void @mlir_linpackcdaxpyrollf64(i32 %73, double %62, ptr %76, ptr %77, i64 %74, i64 %75, i64 1, i32 1, ptr %90, ptr %91, i64 %54, i64 %89, i64 1, i32 1)
  %103 = add i64 %51, 1
  br label %50
...
109:                                              ; preds = %106
  ...
  %113 = call double @get_val_dgesl_f64(ptr %0, ptr %1, i64 %2, i64 %3, i64 %4, i64 %37, i64 %111, i64 %111)
  %114 = extractvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %33, 1
  %115 = getelementptr double, ptr %114, i64 %111
  %116 = load double, ptr %115, align 8
  %117 = fdiv double %116, %113
  %118 = extractvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %33, 1
  %119 = getelementptr double, ptr %118, i64 %111
  store double %117, ptr %119, align 8
  %120 = fneg double %117
  %121 = call i64 @get_offset_dgesl_f64(i64 %37, i64 %111, i64 0)
  %122 = sub i64 %41, %121
  ...
  call void @mlir_linpackcdaxpyrollf64(i32 %112, double %120, ptr %123, ptr %124, i64 %121, i64 %122, i64 1, i32 1, ptr %12, ptr %13, i64 %14, i64 %15, i64 %16, i32 1)
  %136 = add i64 %107, 1
  br label %106
...
142:                                              ; preds = %139
  ...
  %144 = call i64 @get_offset_dgesl_f64(i64 %37, i64 %140, i64 0)
  %145 = sub i64 %41, %144
  ...
  %159 = call double @mlir_linpackcddotrollf64(i32 %143, ptr %146, ptr %147, i64 %144, i64 %145, i64 1, i32 1, ptr %12, ptr %13, i64 %14, i64 %15, i64 %16, i32 1)
  %160 = add i64 %140, 1
  br label %139
...
167:                                              ; preds = %164
  ...
  %174 = call i64 @get_offset_dgesl_f64(i64 %37, i64 %169, i64 %170)
  %175 = sub i64 %41, %174
  ...
  %203 = call double @mlir_linpackcddotrollf64(i32 %172, ptr %176, ptr %177, i64 %174, i64 %175, i64 1, i32 1, ptr %190, ptr %191, i64 %170, i64 %189, i64 1, i32 1)
...
209:                                              ; preds = %167
  ...
  %214 = getelementptr double, ptr %213, i64 %169
  %215 = load double, ptr %214, align 8
  %216 = extractvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %33, 1
  %217 = getelementptr double, ptr %216, i64 %207
  store double %215, ptr %217, align 8
  %218 = extractvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %33, 1
  %219 = getelementptr double, ptr %218, i64 %169
  store double %212, ptr %219, align 8
  br label %220
...
define void @_mlir_ciface_mlir_linpackcdgeslrollf64(ptr %0, i32 %1, i32 %2, ptr %3, ptr %4, i32 %5) {
  ...
  call void @mlir_linpackcdgeslrollf64(ptr %8, ptr %9, i64 %10, i64 %11, i64 %12, i32 %1, i32 %2, ptr %14, ptr %15, i64 %16, i64 %17, i64 %18, ptr %20, ptr %21, i64 %22, i64 %23, i64 %24, i32 %5)
  ret void
}

define void @mlir_linpackcdgeslunrollf64(ptr %0, ptr %1, i64 %2, i64 %3, i64 %4, i32 %5, i32 %6, ptr %7, ptr %8, i64 %9, i64 %10, i64 %11, ptr %12, ptr %13, i64 %14, i64 %15, i64 %16, i32 %17) {
  %19 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } undef, ptr %0, 0
  %20 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %19, ptr %1, 1
  %21 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %20, i64 %2, 2
  %22 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %21, i64 %3, 3, 0
...
72:                                               ; preds = %64, %53
  ...
  %101 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %100, i64 %89, 3, 0
  %102 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %101, i64 1, 4, 0
  call void @mlir_linpackcdaxpyunrollf64(i32 %73, double %62, ptr %76, ptr %77, i64 %74, i64 %75, i64 1, i32 1, ptr %90, ptr %91, i64 %54, i64 %89, i64 1, i32 1)
  %103 = add i64 %51, 1
  br label %50
...
109:                                              ; preds = %106
  ...
  %134 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %133, i64 %122, 3, 0
  %135 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %134, i64 1, 4, 0
  call void @mlir_linpackcdaxpyunrollf64(i32 %112, double %120, ptr %123, ptr %124, i64 %121, i64 %122, i64 1, i32 1, ptr %12, ptr %13, i64 %14, i64 %15, i64 %16, i32 1)
  %136 = add i64 %107, 1
  br label %106
...
142:                                              ; preds = %139
  ...
  %157 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %156, i64 %145, 3, 0
  %158 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %157, i64 1, 4, 0
  %159 = call double @mlir_linpackcddotunrollf64(i32 %143, ptr %146, ptr %147, i64 %144, i64 %145, i64 1, i32 1, ptr %12, ptr %13, i64 %14, i64 %15, i64 %16, i32 1)
  %160 = add i64 %140, 1
  br label %139
...
167:                                              ; preds = %164
  ...
  %201 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %200, i64 %189, 3, 0
  %202 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %201, i64 1, 4, 0
  %203 = call double @mlir_linpackcddotunrollf64(i32 %172, ptr %176, ptr %177, i64 %174, i64 %175, i64 1, i32 1, ptr %190, ptr %191, i64 %170, i64 %189, i64 1, i32 1)
  %204 = extractvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %28, 1
  %205 = getelementptr i32, ptr %204, i64 %169
  %206 = load i32, ptr %205, align 4
  %207 = sext i32 %206 to i64
...
define void @_mlir_ciface_mlir_linpackcdgeslunrollf64(ptr %0, i32 %1, i32 %2, ptr %3, ptr %4, i32 %5) {
  %7 = load { ptr, ptr, i64, [1 x i64], [1 x i64] }, ptr %0, align 8
  %8 = extractvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %7, 0
  %9 = extractvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %7, 1
  %10 = extractvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %7, 2
  ...
  %23 = extractvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %19, 3, 0
  %24 = extractvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %19, 4, 0
  call void @mlir_linpackcdgeslunrollf64(ptr %8, ptr %9, i64 %10, i64 %11, i64 %12, i32 %1, i32 %2, ptr %14, ptr %15, i64 %16, i64 %17, i64 %18, ptr %20, ptr %21, i64 %22, i64 %23, i64 %24, i32 %5)
  ret void
}
