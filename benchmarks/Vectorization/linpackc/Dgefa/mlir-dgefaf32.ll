...
declare i32 @mlir_linpackcidamaxf32(i32, ptr, ptr, i64, i64, i64, i32)

declare void @mlir_linpackcdscalrollf32(i32, float, ptr, ptr, i64, i64, i64, i32)

declare void @mlir_linpackcdaxpyrollf32(i32, float, ptr, ptr, i64, i64, i64, i32, ptr, ptr, i64, i64, i64, i32)

declare void @mlir_linpackcdscalunrollf32(i32, float, ptr, ptr, i64, i64, i64, i32)

declare void @mlir_linpackcdaxpyunrollf32(i32, float, ptr, ptr, i64, i64, i64, i32, ptr, ptr, i64, i64, i64, i32)

declare i32 @_mlir_ciface_mlir_linpackcidamaxf32(i32, ptr, i32)

declare void @_mlir_ciface_mlir_linpackcdscalrollf32(i32, float, ptr, i32)

declare void @_mlir_ciface_mlir_linpackcdaxpyrollf32(i32, float, ptr, i32, ptr, i32)

declare void @_mlir_ciface_mlir_linpackcdscalunrollf32(i32, float, ptr, i32)

declare void @_mlir_ciface_mlir_linpackcdaxpyunrollf32(i32, float, ptr, i32, ptr, i32)

define float @get_val_dgefa_f32(ptr %0, ptr %1, i64 %2, i64 %3, i64 %4, i64 %5, i64 %6, i64 %7) {
...
define float @_mlir_ciface_get_val_dgefa_f32(ptr %0, i64 %1, i64 %2, i64 %3) {
  ...
  %11 = call float @get_val_dgefa_f32(ptr %6, ptr %7, i64 %8, i64 %9, i64 %10, i64 %1, i64 %2, i64 %3)
  ret float %11
}

define void @set_val_dgefa_f32(ptr %0, ptr %1, i64 %2, i64 %3, i64 %4, i64 %5, i64 %6, i64 %7, float %8) {
...
define void @_mlir_ciface_set_val_dgefa_f32(ptr %0, i64 %1, i64 %2, i64 %3, float %4) {
  ...
  call void @set_val_dgefa_f32(ptr %7, ptr %8, i64 %9, i64 %10, i64 %11, i64 %1, i64 %2, i64 %3, float %4)
  ret void
}

define i64 @get_offset_dgefa_f32(i64 %0, i64 %1, i64 %2) {
  %4 = mul i64 %0, %1
  %5 = add i64 %4, %2
  ret i64 %5
}

define i64 @_mlir_ciface_get_offset_dgefa_f32(i64 %0, i64 %1, i64 %2) {
  %4 = call i64 @get_offset_dgefa_f32(i64 %0, i64 %1, i64 %2)
  ret i64 %4
}

define void @mlir_linpackcdgefarollf32(ptr %0, ptr %1, i64 %2, i64 %3, i64 %4, i32 %5, i32 %6, ptr %7, ptr %8, i64 %9, i64 %10, i64 %11, ptr %12, ptr %13, i64 %14) {
...
43:                                               ; preds = %40
  ...
  %46 = add i32 %45, 1
  %47 = sub i32 %6, %45
  %48 = call i64 @get_offset_dgefa_f32(i64 %33, i64 %41, i64 %41)
  %49 = sub i64 %37, %48
  ...
  %63 = call i32 @mlir_linpackcidamaxf32(i32 %47, ptr %50, ptr %51, i64 %48, i64 %49, i64 1, i32 1)
  %64 = add i32 %63, %45
  %65 = extractvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %25, 1
  %66 = getelementptr i32, ptr %65, i64 %41
  store i32 %64, ptr %66, align 4
  %67 = sext i32 %64 to i64
  %68 = call float @get_val_dgefa_f32(ptr %0, ptr %1, i64 %2, i64 %3, i64 %4, i64 %33, i64 %41, i64 %41)
  %69 = call float @get_val_dgefa_f32(ptr %0, ptr %1, i64 %2, i64 %3, i64 %4, i64 %33, i64 %41, i64 %67)
...
73:                                               ; preds = %71
  call void @set_val_dgefa_f32(ptr %0, ptr %1, i64 %2, i64 %3, i64 %4, i64 %33, i64 %41, i64 %67, float %68)
  call void @set_val_dgefa_f32(ptr %0, ptr %1, i64 %2, i64 %3, i64 %4, i64 %33, i64 %41, i64 %41, float %69)
  br label %74

74:                                               ; preds = %73, %71
  %75 = call float @get_val_dgefa_f32(ptr %0, ptr %1, i64 %2, i64 %3, i64 %4, i64 %33, i64 %41, i64 %41)
  %76 = fdiv float -1.000000e+00, %75
  %77 = sub i32 %6, %46
  %78 = call float @get_val_dgefa_f32(ptr %0, ptr %1, i64 %2, i64 %3, i64 %4, i64 %33, i64 %41, i64 %44)
  %79 = call i64 @get_offset_dgefa_f32(i64 %33, i64 %41, i64 %44)
  %80 = sub i64 %37, %79
  ...
  call void @mlir_linpackcdscalrollf32(i32 %77, float %76, ptr %81, ptr %82, i64 %79, i64 %80, i64 1, i32 1)
  br label %94
...
97:                                               ; preds = %94
  %98 = call float @get_val_dgefa_f32(ptr %0, ptr %1, i64 %2, i64 %3, i64 %4, i64 %33, i64 %95, i64 %67)
  br i1 %72, label %99, label %101

99:                                               ; preds = %97
  %100 = call float @get_val_dgefa_f32(ptr %0, ptr %1, i64 %2, i64 %3, i64 %4, i64 %33, i64 %95, i64 %41)
  call void @set_val_dgefa_f32(ptr %0, ptr %1, i64 %2, i64 %3, i64 %4, i64 %33, i64 %95, i64 %67, float %100)
  call void @set_val_dgefa_f32(ptr %0, ptr %1, i64 %2, i64 %3, i64 %4, i64 %33, i64 %95, i64 %41, float %98)
  br label %101

101:                                              ; preds = %99, %97
  %102 = call i64 @get_offset_dgefa_f32(i64 %33, i64 %41, i64 %44)
  %103 = sub i64 %37, %102
  ...
  %117 = call i64 @get_offset_dgefa_f32(i64 %33, i64 %95, i64 %44)
  %118 = sub i64 %37, %117
  ...
  call void @mlir_linpackcdaxpyrollf32(i32 %77, float %98, ptr %104, ptr %105, i64 %102, i64 %103, i64 1, i32 1, ptr %119, ptr %120, i64 %117, i64 %118, i64 1, i32 1)
  %132 = add i64 %95, 1
  br label %94
...
139:                                              ; preds = %138, %15
  ...
  %144 = call float @get_val_dgefa_f32(ptr %0, ptr %1, i64 %2, i64 %3, i64 %4, i64 %33, i64 %140, i64 %140)
  %145 = fcmp ueq float %144, 0.000000e+00
...
define void @_mlir_ciface_mlir_linpackcdgefarollf32(ptr %0, i32 %1, i32 %2, ptr %3, ptr %4) {
  %6 = load { ptr, ptr, i64, [1 x i64], [1 x i64] }, ptr %0, align 8
  %7 = extractvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %6, 0
  %8 = extractvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %6, 1
  %9 = extractvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %6, 2
  ...
  call void @mlir_linpackcdgefarollf32(ptr %7, ptr %8, i64 %9, i64 %10, i64 %11, i32 %1, i32 %2, ptr %13, ptr %14, i64 %15, i64 %16, i64 %17, ptr %19, ptr %20, i64 %21)
  ret void
}

define void @mlir_linpackcdgefaunrollf32(ptr %0, ptr %1, i64 %2, i64 %3, i64 %4, i32 %5, i32 %6, ptr %7, ptr %8, i64 %9, i64 %10, i64 %11, ptr %12, ptr %13, i64 %14) {
  %16 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } undef, ptr %0, 0
  %17 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %16, ptr %1, 1
  %18 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %17, i64 %2, 2
  %19 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %18, i64 %3, 3, 0
...
74:                                               ; preds = %73, %71
  ...
  %92 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %91, i64 %80, 3, 0
  %93 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %92, i64 1, 4, 0
  call void @mlir_linpackcdscalunrollf32(i32 %77, float %76, ptr %81, ptr %82, i64 %79, i64 %80, i64 1, i32 1)
  br label %94
...
101:                                              ; preds = %99, %97
  ...
  %130 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %129, i64 %118, 3, 0
  %131 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %130, i64 1, 4, 0
  call void @mlir_linpackcdaxpyunrollf32(i32 %77, float %98, ptr %104, ptr %105, i64 %102, i64 %103, i64 1, i32 1, ptr %119, ptr %120, i64 %117, i64 %118, i64 1, i32 1)
  %132 = add i64 %95, 1
  br label %94
...
define void @_mlir_ciface_mlir_linpackcdgefaunrollf32(ptr %0, i32 %1, i32 %2, ptr %3, ptr %4) {
  %6 = load { ptr, ptr, i64, [1 x i64], [1 x i64] }, ptr %0, align 8
  %7 = extractvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %6, 0
  %8 = extractvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %6, 1
  %9 = extractvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %6, 2
  ...
  %20 = extractvalue { ptr, ptr, i64 } %18, 1
  %21 = extractvalue { ptr, ptr, i64 } %18, 2
  call void @mlir_linpackcdgefaunrollf32(ptr %7, ptr %8, i64 %9, i64 %10, i64 %11, i32 %1, i32 %2, ptr %13, ptr %14, i64 %15, i64 %16, i64 %17, ptr %19, ptr %20, i64 %21)
  ret void
}
