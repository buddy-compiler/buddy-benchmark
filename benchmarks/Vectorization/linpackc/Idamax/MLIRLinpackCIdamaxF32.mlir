...
// 	}
  ^continue2:
    ...
    %dx_0 = memref.load %dx[%c0] : memref<?xf32>
    %dx_double = arith.extf %dx_0 : f32 to f64
    ...
    iter_args(%dmax_iter = %dmax_0, %ix_iter = %ix_1_index, %itemp_iter = %itemp_0_index) -> (f64, index, index) {
      %dx_1 = memref.load %dx[%ix_iter] : memref<?xf32>
      %dx_1_double =  arith.extf %dx_1 : f32 to f64
...
// 	return (itemp);
    ...
    %dx_0_1 = memref.load %dx[%c0] : memref<?xf32>
    %dx_0_1_double = arith.extf %dx_0_1 : f32 to f64
    ...
    iter_args(%dmax_iter_1 = %dmax_0_1, %itemp_iter_1 = %itemp_0_1_index) -> (f64, index) {
      %dx_1_1 = memref.load %dx[%i_0_1] : memref<?xf32>
      %dx_1_1_double =  arith.extf %dx_1_1 : f32 to f64
