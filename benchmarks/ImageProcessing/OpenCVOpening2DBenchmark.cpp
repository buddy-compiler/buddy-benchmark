...
//===----------------------------------------------------------------------===//
//
// This file implements the benchmark for OpenCV Opening2D.
//
//===----------------------------------------------------------------------===//
...
Mat inputImageOpening2D, kernelOpening2D, outputOpening2D;
...
void initializeOpenCVOpening2D(char **argv) {
  ...
  kernelOpening2D = Mat(get<1>(kernelMap1[argv[4]]), get<2>(kernelMap1[argv[4]]),
